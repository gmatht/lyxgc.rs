...
#ifdef LACHECK_LIB
#include <setjmp.h>
jmp_buf lacheck_exit_buf;
#define exit(x) longjmp(lacheck_exit_buf, (int)(x))
#endif
 ...
 *    } was eaten after display math.  Reported by Eckhard Rùggeberg
 *    <eckhard@ts.go.dlr.de>.
 * 13-Aug-1993          Per Abrahamsen
 *    Recognize \verb*.  Reported by Eckhard Rùggeberg
 *    <eckhard@ts.go.dlr.de>.  
...
#ifdef LACHECK_LIB
int lacheck_main(int argc, char *argv[])
#else
